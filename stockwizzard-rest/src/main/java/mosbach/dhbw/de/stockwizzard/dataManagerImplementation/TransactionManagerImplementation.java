...
public class TransactionManagerImplementation implements ITransactionManager {
    ...
    private static TransactionManagerImplementation databaseUser = null;
    ...
    public void createTransactionTable() {
        ...
        try {
            ...
            Logger.getLogger("CreateTransactionTableLogger").log(Level.SEVERE,
                    "Transaction table cannot be created. Error: {0}", e);
            e.printStackTrace();
        } finally {
            try {
                if (stmt != null)
    ...
    public void addTransaction(TransactionContent transactionContent) {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger("SetNewTransactionWriter").log(Level.SEVERE,
                        "Error when closing the resource. Error: {0}", e);
                e.printStackTrace();
            }
        }
    ...
    public List<Transaction> getAllTransactions(String email, String sortby) {
        ...
        try {
            ...
            String getTransactionsSQL = "SELECT * FROM group12transaction WHERE email = '" + email + "' ORDER BY "
                    + sortby + " DESC";

            ResultSet rs = stmt.executeQuery(getTransactionsSQL);
            while (rs.next()) {
                Double leftInPortfolio = rs.getString("leftinportfolio") != null
            ...
            Logger.getLogger("GetTransactionsLoger").log(Level.INFO, "Error when getting all transactions. Error: {0}",
                    e);
            e.printStackTrace();
        } finally {
            try {
                ...
                Logger.getLogger("GetTransactionsLoger").log(Level.SEVERE,
                        "Error when getting the resource. Error: {0}", e);
                e.printStackTrace();
            }
        }
        return transactions;
    ...
    // Get all transactions whose stock purchases are still active in the
    // portfoliostocks
    public List<Transaction> getAllTransactionsInPortfolioStock(String email) {
        ...
        try {
            ...
            String getPortfolioStockTransactionsSQL = "SELECT * FROM group12transaction WHERE email = '" + email
                    + "' AND leftinportfolio > 0 AND transactiontype = 1 ORDER BY date DESC";
            ...
            Logger.getLogger("GetTransactionsLoger").log(Level.INFO,
                    "Error when getting all transactions with stocks in portfolio stocks. Error: {0}", e);
            e.printStackTrace();
        } finally {
            try {
                if (stmt != null)
    ...
    public void editLeftinPortfolio(Integer transactionId, Double newLeftInPortfolio) {
        ...
        try {
            ...
            String updateLeftinPortfolioTransactionSQL = "UPDATE group12transaction SET leftinportfolio = "
                    + newLeftInPortfolio + "WHERE transactionId = " + transactionId;

            stmt.executeUpdate(updateLeftinPortfolioTransactionSQL);
        } catch (Exception e) {
            Logger.getLogger("UpdateLeftinPortfolioLogger").log(Level.INFO,
                    "Error when updating leftinportfolio value. Error: {0}", e);
            e.printStackTrace();
        } finally {
            try {
                if (stmt != null)
                ...
                Logger.getLogger("UpdateLeftinPortfolioLogger").log(Level.SEVERE,
                        "Error when closing the resource. Error: {0}", e);
                e.printStackTrace();
            }
        }
    ...
    public void editTransactionEmail(String email, String newEmail) {
        ...
        try {
            ...
            String updateTransactionEmailSQL = "UPDATE group12transaction SET email = '" + newEmail
                    + "' WHERE email = '" + email + "'";

            stmt.executeUpdate(updateTransactionEmailSQL);
        } catch (SQLException e) {
            Logger.getLogger("UpdateTransactionEmailLogger").log(Level.SEVERE,
                    "Error when updating email of a transaction.", e);
            e.printStackTrace();
        } finally {
            try {
                if (stmt != null)
                ...
                Logger.getLogger("UpdateTransactionEmailLogger").log(Level.SEVERE, "Error when closing the resource.",
                        e);
                e.printStackTrace();
            }
        }
    ...
    public void deleteAllTransactions(String email) {
        ...
        try {
            ...
            Logger.getLogger("DeleteAllTransactionsLogger").log(Level.SEVERE, "Error when deleting all transactions.",
                    e);
            e.printStackTrace();
        } finally {
            try {
                ...
                Logger.getLogger("DeleteAllTransactionsLogger").log(Level.SEVERE, "Error when closing the resource.",
                        e);
                e.printStackTrace();
            }
        }
